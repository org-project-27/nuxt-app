...
export function detectBrowserLanguage(route, nuxtI18nOptions, nuxtI18nInternalOptions, vueI18nOptions, detectLocaleContext, localeCodes = [], locale = "") {
...
export function getDomainFromLocale(localeCode, locales) {
