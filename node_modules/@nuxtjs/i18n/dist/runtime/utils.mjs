...
export async function loadAndSetLocale(newLocale, localeMessages, i18n, {
...
export function detectLocale(route, routeLocaleGetter, nuxtI18nOptions, vueI18nOptions, initialLocaleLoader, detectLocaleContext, normalizedLocales, localeCodes = []) {
...
export function extendSwitchLocalePathIntercepter(differentDomains, normalizedLocales) {
  return (path, locale) => {
    if (differentDomains) {
