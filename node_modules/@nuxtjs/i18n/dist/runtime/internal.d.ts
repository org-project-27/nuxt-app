...
export declare function getBrowserLocale(options: Required<NuxtI18nInternalOptions>): string | undefined;
export declare function getLocaleCookie({ useCookie, cookieKey, localeCodes }?: Pick<DetectBrowserLanguageOptions, 'useCookie' | 'cookieKey'> & {
    localeCodes?: readonly string[];
}): string | undefined;
export declare function setLocaleCookie(locale: string, { useCookie, cookieKey, cookieDomain, cookieSecure, cookieCrossOrigin }?: Pick<DetectBrowserLanguageOptions, 'useCookie' | 'cookieDomain' | 'cookieKey' | 'cookieSecure' | 'cookieCrossOrigin'>): void;
...
export declare function detectBrowserLanguage<Context extends NuxtApp = NuxtApp>(route: string | Route | RouteLocationNormalized | RouteLocationNormalizedLoaded, nuxtI18nOptions: DeepRequired<NuxtI18nOptions<Context>>, nuxtI18nInternalOptions: DeepRequired<NuxtI18nInternalOptions>, vueI18nOptions: I18nOptions, detectLocaleContext: DetectLocaleContext, localeCodes?: string[], locale?: Locale): DetectBrowserLanguageFromResult;
export declare function getHost(): string | undefined;
export declare function getLocaleDomain(locales: LocaleObject[]): string;
export declare function getDomainFromLocale(localeCode: Locale, locales: LocaleObject[]): string | undefined;
