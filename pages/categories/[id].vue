  ...
  <div class="box default-container">
    ...
    <form
      ...
      <input-component
          ...
          :show-warning="{
            message: registerFormStore['lastname'],
