...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "box" }, _attrs))} data-v-e7d657f7>`);
      ...
      _push(`<br data-v-e7d657f7><br data-v-e7d657f7><form class="flex-column-no-wrap" style="${ssrRenderStyle({ "gap": "20px" })}" data-v-e7d657f7>`);
      ...
      _push(`</form> ${ssrInterpolate(_ctx.$t("buttons.search"))} <div class="responsive-test flex-row-center" data-v-e7d657f7><div class="show-for-large" data-v-e7d657f7> show-for-large </div><div class="show-for-desktop" data-v-e7d657f7> show-for-desktop </div><div class="show-for-tablet" data-v-e7d657f7> show-for-tablet </div><div class="show-for-mobile" data-v-e7d657f7> show-for-mobile </div><div class="show-for-extrasmall" data-v-e7d657f7> show-for-extrasmall </div></div></div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/categories/example/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e7d657f7"]]);
export {
  _id_ as default
};
//# sourceMappingURL=_id_-WkDsC2P-.js.map
