import { effectScope, reactive, hasInjectionContext, getCurrentInstance, version, unref, inject, ref, watchEffect, watch, toRef, h, nextTick, markRaw, isRef, isReactive, toRaw, computed, getCurrentScope, onScopeDispose, toRefs, shallowRef, shallowReactive, isReadonly, isShallow, defineComponent, provide, Suspense, mergeProps, Transition, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-zTSXOZ6W.js").then((m) => m.default || m)
  },
  {
    name: "account-cart",
    path: "/account/cart",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/cart-a-F-doFq.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/favorites-rK5w--h9.js").then((m) => m.default || m)
  },
  {
    name: "account-user",
    path: "/account/user",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/user-51d4lnPW.js").then((m) => m.default || m)
  },
  {
    name: "categories-id",
    path: "/categories/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-UsaxyfCc.js").then((m) => m.default || m)
  },
  {
    name: "categories-example-id",
    path: "/categories/example/:id()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-WkDsC2P-.js").then((m) => m.default || m)
  },
  {
    name: "color_pallet",
    path: "/color_pallet",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/color_pallet-yyoZ8byV.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/forgot_password-5u6vc3I8.js").then((m) => m.default || m)
  },
  {
    name: "getstarted",
    path: "/getstarted",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/getstarted-JdqGT_yS.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-b8hDhy4l.js").then((m) => m.default || m)
  },
  {
    name: "posts-id",
    path: "/posts/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-Rp1VQ4Uf.js").then((m) => m.default || m)
  },
  {
    name: "posts-example-id",
    path: "/posts/example/:id()",
    meta: {},
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-6IkcRVAi.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/privacy_and_policy--ei7Jxbu.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/terms_of_service-OMZ1bVd0.js").then((m) => m.default || m)
  }
];
...
function developerAnnounce(message, type = "error") {
...
function processByConfig(to, from, config = routeConfig.default) {
...
const layouts = {
  custom: () => import("./_nuxt/custom-SOyzpztz.js").then((m) => m.default || m),
  default: () => import("./_nuxt/default-hqJYx1P7.js").then((m) => m.default || m),
  general: () => import("./_nuxt/general-qOGEIu0m.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-qGKbxKGR.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-d8Nw81S-.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-1U0LVSUK.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export {
  ...
  fetchDefaults as f,
  backendMessage as g,
  developerAnnounce as h,
  generateUniqueId as i,
  useRouter as j,
